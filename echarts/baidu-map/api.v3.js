...
window.BMAP_AUTHENTIC_KEY = "Hv51OkEaOn2CPZAxzVLi3ZGB9l3r7sfo";
(function () {
    function ba(a) {
        throw a;
    }
    ...
    A.VK = function () {
        function a(a) {
            document.addEventListener && (this.element = a, this.YK = this.Lk ? "touchstart" : "mousedown",
                this.lD = this.Lk ? "touchmove" : "mousemove", this.kD = this.Lk ? "touchend" : "mouseup",
                this.yh = t, this.qu = this.pu = 0, this.element.addEventListener(this.YK, this, t), ja.V(
                    this.element, "mousedown", u()), this.handleEvent(q))
        }
        a.prototype = {
            ...
            move: function (a) {
                ...
                if (10 < Math.abs((this.Lk ? a.touches[0].clientX : a.clientX) - this.pu) || 10 < Math.abs(
                        c - this.qu)) this.yh = p
            },
            end: function (a) {
                oa(a);
                this.yh || (a = document.createEvent("Event"), a.initEvent("tap", t, p), this.element.dispatchEvent(
                    a));
    ...
    A.extend(Na.prototype, {
        ...
        Rg: function (a, b) {
            if ($a(a) && (this.av(), this.dispatchEvent(new P("onzoomstart")), a = this.$n(a).zoom, a !==
                    this.Za)) {
                this.Bc = this.Za;
                this.Za = a;
                var c;
                b ? c = b : this.qh() && (c = this.qh().ma());
                c && (c = this.oo(Za(c, this.M.Ma), this.Bc), this.qk(this.width / 2 - c.x, this.height /
                    2 - c.y, this.pg(c, this.Bc), p));
        ...
        zi: function (a) {
            if (a instanceof Q || a instanceof L) a = Za(a, this.M.Ma), this.Vb = this.Fc.ri(a, this.Ob),
                this.he = Q.mE(a) ? new L(a.lng, a.lat) : this.Fc.xh(this.Vb, this.Ob)
        },
        Kg: function (a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        Cb: function () {
            return this.As && this.As instanceof N ? new N(this.As.width, this.As.height) : new N(this.cb
                .clientWidth, this.cb.clientHeight)
        },
        He: function (a) {
            a && a instanceof N ? (this.As = a, this.cb.style.width = a.width + "px", this.cb.style.height =
                a.height + "px") : this.As = q
        },
        Qb: function () {
        ...
        ht: function (a, b) {
            ...
            b.margins && (e = b.margins, g = (e[1] - e[3]) / 2, e = (e[0] - e[2]) / 2, i = this.ya().$b(
                    f), b.offset && (g = b.offset.width, e = b.offset.height), c.lng += i * g, c.lat +=
                i * e);
        ...
        U3: function (a, b) {
            ...
            b.styleJson ? i += "styles=" + encodeURIComponent(this.FF(b.styleJson, parseInt(a, 10))) :
                b.styleId && (i += "styles=" + encodeURIComponent(c.FF(c.b0, parseInt(a, 10))));
        ...
        bu: function (a) {
            ...
            if (a) {
                ...
                Sa(5050, c);
                a.style && (c = b.M.pC[a.style] ? b.M.pC[a.style].backColor : b.M.pC.normal.backColor) &&
        ...
        FF: function (a, b) {
            ...
            for (var i = 0, k; k = a[i]; i++)
                if (!this.OY(k)) {
                    b = this.uX(k, b);
                    if (("land" === k.featureType || "all" === k.featureType || "background" === k.featureType) &&
                        "string" === typeof k.elementType && ("geometry" === k.elementType ||
                            "geometry.fill" === k.elementType || "all" === k.elementType) && k.stylers)
                        k.stylers.color && (window[c + "zoomFrontStyle"][b].bmapLandColor = k.stylers.color),
                        k.stylers.visibility && "off" === k.stylers.visibility && (window[c +
                            "zoomFrontStyle"][b].bmapLandColor = "#00000000");
                    "railway" === k.featureType && ("string" === typeof k.elementType && k.stylers) &&
                        (k.stylers.color && ("geometry" === k.elementType && (window[c +
                            ...
                            ), "geometry.fill" === k.elementType && (window[c + "zoomFrontStyle"][b]
                                .bmapRailwayFillColor = k.stylers.color), "geometry.stroke" === k.elementType &&
                            (window[c + "zoomFrontStyle"][b].bmapRailwayStrokeColor = k.stylers.color)
                        ), k.stylers.visibility && (window[c + "zoomFrontStyle"][b].bmapRailwayVisibility =
        ...
        LO: function () {
            ...
            if (window[a + "zoomFrontStyle"].main.bmapRoadarrowVisibility)
                for (var b = this.Ua.rf(); b <= this.Ua.Ze(); b++) window[a + "zoomFrontStyle"][b].bmapRoadarrowVisibility ||
                    (window[a + "zoomFrontStyle"][b].bmapRoadarrowVisibility = window[a +
                        "zoomFrontStyle"].main.bmapRoadarrowVisibility);
            if (window[a + "zoomFrontStyle"].main.bmapLandColor)
                for (b = this.Ua.rf(); b <= this.Ua.Ze(); b++) window[a + "zoomFrontStyle"][b].bmapLandColor ||
                    (window[a + "zoomFrontStyle"][b].bmapLandColor = window[a + "zoomFrontStyle"].main.bmapLandColor);
            if (window[a + "zoomFrontStyle"].main.bmapRailwayFillColor)
                for (b = this.Ua.rf(); b <= this.Ua.Ze(); b++) window[a + "zoomFrontStyle"][b].bmapRailwayFillColor ||
                    (window[a + "zoomFrontStyle"][b].bmapRailwayFillColor = window[a + "zoomFrontStyle"]
                        .main.bmapRailwayFillColor);
            if (window[a + "zoomFrontStyle"].main.bmapRailwayStrokeColor)
                for (b = this.Ua.rf(); b <= this.Ua.Ze(); b++) window[a + "zoomFrontStyle"][b].bmapRailwayStrokeColor ||
                    (window[a + "zoomFrontStyle"][b].bmapRailwayStrokeColor = window[a +
                        "zoomFrontStyle"].main.bmapRailwayStrokeColor);
            if (window[a + "zoomFrontStyle"].main.bmapRailwayVisibility)
                for (b = this.Ua.rf(); b <= this.Ua.Ze(); b++) window[a + "zoomFrontStyle"][b].bmapRailwayVisibility ||
                    (window[a + "zoomFrontStyle"][b].bmapRailwayVisibility = window[a +
                        "zoomFrontStyle"].main.bmapRailwayVisibility)
        },
        H2: function (a, b) {
            var c = {};
            A.extend(c, a);
    ...
    D.ud = D.url.proto + ("2" == D.Au ? D.url.domain.main_domain_nocdn.other : D.url.domain.main_domain_nocdn.baidu) + "/";
    ...
    var I = {
        ...
        dP: new N(12, 36),
        bG: new N(13, 1),
        ua: D.pa + "http://oto-map.everpolice-fjgj.wh.everark.com.cn/gettitle/map_baidu/images/",
    ...
    function Ob(a) {
        ...
        do c = Mb.indexOf(a.charAt(k++)), e = Mb.indexOf(a.charAt(k++)), g = Mb.indexOf(a.charAt(k++)), i = Mb.indexOf(
        ...
        b.handle.click || (b.addEventListener("click", function (a) {
            for (var c = a.target || a.srcElement; c != b;) {
                Tb(b.FE, function (b, i) {
                    RegExp(i.filter).test(c.getAttribute("filter")) && i.Rs.call(c, a, c.getAttribute(
                        "filter"))
                });
                c = c.parentNode
            }
        ...
        function (a, b, c) {
            ...
            s && (s.Ch && m() < s.Ch) && (c.alog("cus.on", "time", function (a) {
                ...
                if ("[object Object]" === a.toString()) {
                    for (var i in a) "page" == i ? b.page = a[i] : (f = parseInt(a[i]), 0 < f && /^z_/.test(
                        i) && (e = p, b[i] = f));
    ...
    function tc(a) {
        ...
        for (;;) {
            ...
            if (1.0E-6 > g) {
                a: {
                    c = (a.lng + 0.03 - (a.lng - 0.03)) / 1.0E-4 + 0.5;g = (a.lat + 0.03 - (a.lat - 0.03)) / 1.0E-4 +
                    0.5;i = a.lng * qc;k = a.lat * qc;y = 1.0E-4 * qc;m = i - y;o = i + y;v = k - y;B = k + y;C = n =
                    w = K = l;F = n = y = E = w = K = 0;b(a);C = l;
                    for (O = 0; O <= c; O++) {
                        for (e = 0; e <= g; e++)
        ...
        if ((0 === g ? mc : nc) === mc) {
            for (g = 0; g < $b; ++g)
                if (e = new yc(ac[g], cc[g], ac[(g + 1) % $b], cc[(g + 1) % $b]), f.Gg.lng = e.$x.Gg.lng - 0.5, f.Gg
                    .lat = e.$x.Gg.lat - 0.5, f.Ng.lng = e.$x.Ng.lng + 0.5, f.Ng.lat = e.$x.Ng.lat + 0.5, f.contains(
                        a) !== mc) {
                    var i;
                    var k = e.mu.lng,
                        m = e.mu.lat,
                    ...
                    i = o - m;
                    var s = k - n;
                    !(Math.abs(i - 0) > oc) && !(Math.abs(s - 0) > oc) ? i = e.mu: (k = n * m - k * o, m = s * a.lng -
                        i * a.lat, n = i * i - s * s, i = {
                            lng: (s * m - i * k) / n,
                            lat: -(i * m + s * k) / n
                        });
                    ...
                    i.lng <= m && i.lng >= s && i.lng <= n && i.lat >= k ? (e = a.lat * ic, s = a.lng * ic, k = i.lat *
                        ic, i = i.lng * ic, m = Math.cos(e) * Math.cos(k), e = m * Math.cos(s) * Math.cos(i) +
                        m * Math.sin(s) * Math.sin(i) + Math.sin(e) * Math.sin(k), -1 > e ? e = -1 : 1 < e && (
                            e = 1), e = Math.acos(e) * pc) : (i = zc(a, e.mu), e = zc(a, e.ex), e = i < e ? i :
                        e);
                    e < c && (c = e)
                } c < lc && (b = (lc - c) / lc)
        } else b = 1;
    ...
    A.Ly = function () {
        ...
        return {
            ...
            set: function (a, g) {
                if (e) {
                    for (var i = b + a + "_", k = c.length, m; k--;) m = c.key(k), -1 < m.indexOf(i) && c.removeItem(
                        m);
                    try {
    ...
    A.object.extend(Ua, {
            ...
            if (e.Se == this.Mj.pq) c && b();
                ...
                if (e.Se == this.Mj.uG) {
                    ...
                    f.CC == t && (f.CC = p, setTimeout(function () {
                        ...
                        0 == a.length ? f.XK() : qa("bdmap/getModules.v3.js");
                        console.log(a);
                    }, 1));
                    e.Se = this.Mj.NP
                }
        ...
        sV: function (a, b) {
            for (var c = this.Xd.bw, e = p, f = 0, g = c.length; f < g; f++) "" == c[f].JE && (c[f].SM ==
                a ? c[f].JE = b : e = t);
            e && this.XK()
        },
        XK: function () {
    ...
    function lb(a, b) {
        a && (this.Mb = a, this.da = "spot" + lb.da++, b = b || {}, this.ih = b.text || "", this.Iv = b.offsets ? b
            .offsets.slice(0) : [5, 5, 5, 5], this.JB = b.userData || q, this.Qh = b.minZoom || q, this.Nf = b.maxZoom ||
            q)
    }
    lb.da = 0;
    ...
    A.object.extend(Oc.prototype, {
        ...
        removeItem: function (a) {
            if (a && "menuitem" == a.Nb) {
                for (var b = 0, c = this.Da.length; b < c; b++) this.Da[b] === a && (this.Da[b].remove(),
                    this.Da.splice(b, 1), c--);
                b = 0;
                for (c = this.Pf.length; b < c; b++) this.Pf[b] === a && (this.Pf[b].remove(), this.Pf.splice(
                    b, 1), c--)
            }
        },
        UB: function () {
        ...
        aF: function (a) {
            if (this.Ke[a]) {
                for (var b = 0, c = this.Da.length; b < c; b++) this.Da[b] && ("divider" == this.Da[b].Nb &&
                    this.Da[b].Uj == a) && (this.Da.splice(b, 1), c--), this.Da[b] && ("divider" ==
                    this.Da[b].Nb && this.Da[b].Uj > a) && this.Da[b].Uj--;
                this.Ke.splice(a, 1)
            }
        },
        dd: x("R"),
    ...
    function ib(a, b) {
        ...
        a && (this.Xl = new Q(a.lng, a.lat), this.Hl = new Q(b.lng, b.lat), this.Te = a.lng, this.ee = a.lat, this.Ne =
            b.lng, this.be = b.lat)
    }
    A.object.extend(ib.prototype, {
        ...
        sf: x("Hl"),
        HV: function (a) {
            return !(a instanceof ib) || this.Aj() || a.Aj() ? t : a.Te > this.Te && a.Ne < this.Ne &&
                a.ee > this.ee && a.be < this.be
        },
        Qb: function () {
            return this.Aj() ? q : new Q((this.Te + this.Ne) / 2, (this.ee + this.be) / 2)
        },
        ot: function (a) {
            if (!(a instanceof ib) || Math.max(a.Te, a.Ne) < Math.min(this.Te, this.Ne) || Math.min(a.Te,
                    a.Ne) > Math.max(this.Te, this.Ne) || Math.max(a.ee, a.be) < Math.min(this.ee, this
                    .be) || Math.min(a.ee, a.be) > Math.max(this.ee, this.be)) return q;
    ...
    A.extend(T, {
        ...
        Lu: [86, 60, 45, 30, 15, 0],
        vP: [[1.410526172116255E-8, 8.98305509648872E-6, -1.9939833816331, 200.9824383106796, -
        ...
        vG: [[-0.0015702102444, 111320.7020616939, 1704480524535203, -10338987376042340, 26112667856603880,
        ...
        Ya: function (a) {
            if (a === q || a === l || 180 < a.lng || -180 > a.lng || 90 < a.lat || -90 > a.lat) return new L(
                0, 0);
            var b, c;
            a.lng = this.KD(a.lng, -180, 180);
        ...
        sK: function (a, b) {
            if (a && b) {
                var c = b[0] + b[1] * Math.abs(a.lng),
                    ...
                    e = b[2] + b[3] * e + b[4] * e * e + b[5] * e * e * e + b[6] * e * e * e * e + b[7] *
                    e * e * e * e * e + b[8] * e * e * e * e * e * e,
                    c = c * (0 > a.lng ? -1 : 1),
                    e = e * (0 > a.lat ? -1 : 1);
                return new L(c, e)
            }
    ...
    A.extend(T.prototype, {
        ...
        vc: function (a, b, c, e, f) {
            if (a) return a = this.ri(a, f), b = this.$b(b), new R(Math.round((a.lng - c.lng) / b + e.width /
                2), Math.round((c.lat - a.lat) / b + e.height / 2))
        },
        hZ: function (a, b, c, e) {
            if (a) return b = this.$b(b), new R(Math.round((a.lng - c.lng) / b + e.width / 2), Math.round(
    ...
    A.extend(Vc.prototype, {
        Me: function (a) {
            if (!this.ca && ab(this.initialize) && (this.ca = this.initialize(a))) this.ca.style.WebkitUserSelect =
                "none";
            this.draw()
        },
        initialize: function () {
    ...
    D.df(function (a) {
        ...
        a.addEventListener("clearoverlays", function () {
            ...
            a = 0;
            for (var e = b.Je.length; a < e; a++) b.Je[a].enableMassClear !== t && (b.Je[a].remove(),
                b.Je[a] = q, b.Je.splice(a, 1), a--, e--)
        });
    ...
    A.extend(Zc.prototype, {
        ...
        x_: function (a, b) {
            ...
            this.ca && (this.ca.style.width = this.K.width + "px", this.ca.style.height = this.K.height +
                "px", this.draw())
        }
    });
    ...
    function $c(a, b, c) {
        a && b && (this.imageUrl = a, this.size = b, a = new N(Math.floor(b.width / 2), Math.floor(b.height / 2)),
            c = c || {}, a = c.anchor || a, b = c.imageOffset || new N(0, 0), this.imageSize = c.imageSize,
    ...
    function cd(a, b) {
        ...
        this.K = {
            ...
            oC: b.collisions || [[10, 10], [10, 10], [10, 10], [10, 10]],
            sY: t,
            xZ: b.onClosing || ea(p),
            UK: t,
    ...
    A.extend(dd.prototype, {
        ...
        va: function (a) {
            if ((a instanceof Q || a instanceof L) && !this.tx()) this.point = this.K.position = new Q(
                a.lng, a.lat)
        },
        Pc: ca("content"),
        qF: function (a) {
    ...
    function id(a, b) {
        var c = this;
        hd() && (a === l && ba(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype
            .toString.call(a) && ba(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, jb.apply(
                c, arguments), c.ia = {
                ja: a
            }, c.K = {
                shape: b.shape || fd,
    ...
    A.extend(W.prototype, {
        ...
        bk: x("point"),
        ma: function () {
            return this.point instanceof Q || this.point instanceof L ? this.map ? db(this.point, this.map
                .M.Ma) : new Q(this.point.lng, this.point.lat) : this.point
        },
        va: function (a) {
            if (a instanceof Q || a instanceof L) this.point = this.map ? Za(a, this.map.M.Ma) : new L(
                a.lng, a.lat)
        },
        Di: function (a, b) {
            this.K.sE = !!a;
    ...
    A.extend(sd.prototype, {
        ...
        LL: function (a, b, c) {
            ...
            n = 0;
            for (e = this.Ie.length; n < e; n++) C = this.Ie[n][0], k = this.Ie[n][1], v = C * f + i[0] -
                c / 2, w = (-1 - k) * f + i[1] - c / 2, z = m + "_" + b + "_" + C + "_" + k + "_" + g,
                o = this.Um[z], s = q, o ? (s = o.style, s.left = v + "px", s.top = w + "px", o.Un ||
                    this.JF.push([C, k, o])) : (0 < this.We.length ? (o = this.We.shift(), o.getContext(
                        "2d").clearRect(-c / 2, -c / 2, y, y), s = o.style) : (o = document.createElement(
                            "canvas"), s = o.style, s.position = "absolute", s.width = f + c + "px", s.height =
                        f + c + "px", this.SY() && (s.WebkitTransform = "scale(1.001)"), o.setAttribute(
                            "width", y), o.setAttribute("height", y), a.appendChild(o)), o.id = z, s.left =
                    v + "px", s.top = w + "px", -1 < z.indexOf("bg") && (v = "#F3F1EC", this.map.M.TU &&
                        (v = this.map.M.TU), s.background = v ? v : ""), this.JF.push([C, k, o])), o.style
                .visibility = "";
            n = 0;
        ...
        V_: function (a, b, c, e) {
            ...
            m && m.Hb ? (Bb(m.Hb, b), e && (e = new R(a[0], a[1]), g = this.map.M.De ? this.map.M.De.style :
                    "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, xd(m, e)), m.loaded ?
                this.Ff() : yd(m, function () {
                    f.Ff()
                ...
                .loaded ? this.Ff() : yd(m, function () {
                    f.Ff()
                })) : (m = k * Math.pow(2, g.Ze() - a[2]), new L(a[0] * m, a[1] * m), e = new R(a[0],
                a[1]), g = this.map.M.De ? this.map.M.De.style : "normal", e = c.getTilesUrl(e,
                a[2], g), m = new zd(this, e, b, a, c), yd(m, function () {
                f.Ff()
            }), m.fo(), this.Ig[i] = m)
        },
        Ff: function () {
        ...
        oV: function (a, b) {
            for (var c = 256 * Math.pow(2, 18 - b), e = Math.floor(this.PA / c), f = Math.floor(this.QA /
                    c), c = Math.floor(this.MA / c), g = [], i = 0; i < a.length; i++) {
                var k = a[i],
                    m = k[0],
                    k = k[1];
                if (m >= e) {
            ...
            for (var k = 0; k < c; k++) {
                ...
                if (m.Gw) {
                    ...
                    if (this.map.Vd()) {
                        ...
                        continue
                    } else n.style.display = "block", this.tg.style.display = "none", this.map.dispatchEvent(
                        new P("vectorchanged"), {
                            isvector: t
                        })
                }
                if (!m.c2 && !(m.Rx && !this.map.Vd() || m.oM && this.map.Vd())) {
                    ...
                    m.Kb && (m.Kb.style.left = Math.ceil(z + C) - g[0] + "px", m.Kb.style.top = Math.ceil(
                        B + G) - g[1] + "px", m.Kb.style.WebkitTransform = "translate3d(0,0,0)");
                    z = [];
                    for (e.LB = []; v < y; v++)
        ...
        bu: function (a) {
            ...
            if (!this.map.Vd() && (a ? this.map.M.d0 = a : a = this.map.M.d0, a))
                for (var c = q, c = "2" == D.Au ? [D.url.proto + D.url.domain.main_domain_cdn.other[0] +
                        "/"] : [D.url.proto + D.url.domain.main_domain_cdn.baidu[0] + "/", D.url.proto +
                        D.url.domain.main_domain_cdn.baidu[1] + "/", D.url.proto + D.url.domain.main_domain_cdn
                        .baidu[2] + "/"], e = 0, f; f = this.Cj[e]; e++)
                    if (f.Q_ == p) {
                        b.m.qc = 18;
    ...
    zd.prototype.fo = function () {
        this.Hb.src = 0 < A.ga.oa && 6 >= A.ga.oa && this.vJ ? I.ua + "blank.gif" : "" !== this.src && this.Hb.src ==
    ...
    Cd.prototype.getTilesUrl = function (a, b) {
        var c = "";
        this.m.predictDate ? c = "HistoryService?day=" + (this.m.predictDate.weekday - 1) + "&hour=" + this.m.predictDate
    ...
    var Dd = [D.url.proto + D.url.domain.TILES_YUN_HOST[0] + "/georender/gss", D.url.proto + D.url.domain.TILES_YUN_HOST[
                1] + "/georender/gss", D.url.proto + D.url.domain.TILES_YUN_HOST[2] + "/georender/gss", D.url.proto +
            D.url.domain.TILES_YUN_HOST[3] + "/georender/gss"],
    ...
    var Md = {
        ...
        DW: function (a, b, c, e) {
            ...
            if (!c.Xb || !(6 < e && (71013 === c.Xb || 71012 === c.Xb || 71011 === c.Xb) || 6 === e && (
                        71011 === c.Xb || 71012 === c.Xb) || 5 === e && (71011 === c.Xb || 71013 === c.Xb) ||
    ...
    var Nd = {
        ...
        kV: function (a, b) {
            ...
            return [[g + 4.8410665352790705 * Math.cos(c - 0.3), f + 4.8410665352790705 * Math.sin(c - 0.3)],
    ...
    var Pd = {
        parse: function (a, b, c, e, f) {
            for (var g = e.P, i = g.la(), k = Math.pow(2, 18 - i), m = g.Fc.ri(g.Qb()), n = m.lng, o = m.lat,
                    m = g.Cb(), s = m.width, v = m.height, m = [], w = 0; w < a.length; w++) {
                var y = [],
                    z = a[w].m0;
                y.x = z[0];
                y.y = z[1];
                ...
                for (var B = (z[0] * c * k - n) / k + s / 2, C = (o - (z[1] + 1) * c * k) / k + v / 2, E =
                        0; E < a[w].length; E++) a[w][E].uM ? this.sN(a[w][E].uM, z, e, b, c, B, C, i, k, s,
                    v, y) : a[w][E].uY ? this.sN(a[w][E].uY, z, e, b, c, B, C, i, k, s, v, y, p, window
            ...
            for (w = 0; w < a.length; w++)
                if (c = a[w], !c.vt)
                    if (E = [c.Zf, c.$f, c.Zf, c.vi, c.ui, c.vi, c.ui, c.$f, c.Zf, c.$f], c.style && g.Go(
                        ...
                        if (c.style && !E)
                            for (E = 0; E < c.Bf.length; E++) this.NK(b, c.Bf[E].ie, c.Bf[E].je, c.Bf[E].text,
                                c.style, e)
                    } else if ("line" === c.type)
                for (E = 0; E < c.$O.length; E++) f = c.$O[E], Pd.xW(b, f.ie, f.je, f.OU, f.YO, f.width, f.height,
                    c.style, e);
            return m
        },
        ...
        HZ: function (a, b, c, e, f, g, i, k, m, n, o, s, v) {
            ...
            if ((n = c.wj(a[0], "pointText", k)) && n.length) {
                ...
                if (y) {
                    ...
                    for (E = 2; E < B.length; E += 2) 0 === E % (2 * z) || 1 === E % (2 * z) || (C[E] = C[E -
                        2] + B[E] / v, C[E + 1] = C[E - 1] + B[E + 1] / v);
                    for (v = 0; v < b; v++)
                        if (c.Uc(a[7][v], k)) {
                            var E = [],
                                G = l,
        ...
        VZ: function (a, b) {
            ...
            for (var f = 0, g = a.length; f < g; f++)
                for (var i = a[f], k = 0, m = i.length; k < m; k++) {
                    ...
                    } else "line" === n.type ? (o = n.Zf, s = n.$f, v = n.ui, w = n.vi) : "biaopai" === n.type &&
                        (w = n.y5, o = w.ie, s = w.je, v = w.ie + w.width, w = w.je + w.height);
            ...
            for (g = c.length; f < g; f++) {
                ...
                m.vt = t;
                m.WJ = [];
                for (k = f + 1; k < g; k++) i = c[k], m.ui - e < i.Zf || (m.Zf > i.ui - e || m.vi - e < i.$f ||
                    m.$f > i.vi - e) || m.WJ.push(k)
            }
            f = 0;
            for (g = c.length; f < g; f++)
                if (k = c[f], k.vt === t) {
    ...
    function Vd(a, b, c) {
        if (/^tielu|^MapRes\/tielu/.test(a)) {
            ...
            var e = "#ffffff",
                f = "#949494";
            window[c + "zoomFrontStyle"] && (window[c + "zoomFrontStyle"][b] && window[c + "zoomFrontStyle"][b].bmapRailwayStrokeColor) &&
                (e = window[c + "zoomFrontStyle"][b].bmapRailwayStrokeColor);
            window[c + "zoomFrontStyle"] && (window[c + "zoomFrontStyle"][b] && window[c + "zoomFrontStyle"][b].bmapRailwayFillColor) &&
    ...
    var Wd = {
        ...
        yW: function (a, b, c, e, f) {
            ...
            c.borderWidth && e ? (a.strokeStyle = c.Mo, a.lineCap = Qd[c.dV], a.lineJoin = Rd[1], a.lineWidth =
                c.borderWidth / 2, a.stroke()) : e || (a.strokeStyle = c.hx, a.lineCap = Qd[c.UW], a.lineJoin =
                Rd[1], a.lineWidth = c.$K / 2, a.stroke())
        },
    ...
    he.prototype = {
        ...
        MK: function (a, b, c, e) {
            ...
            if (a[0])
                for (var g = 0; g < a[0].length; g++) {
                    var i = a[0][g],
                        k = i[0];
                    k === Yd ? Wd.drawLink(i, b, c, e, this) : k === be ? Wd.drawLink(i, b, c, e, this) : k ===
                        ae ? (Md.drawGaoqingRoadBorder(i, b, c, e, this), Md.drawGaoqingRoadFill(i, b, c, e,
                            this)) : 18 === k ? window[f + "zoomFrontStyle"] && (window[f +
                            "zoomFrontStyle"][c] && "off" !== window[f + "zoomFrontStyle"][c].bmapRoadarrowVisibility) &&
                        Nd.drawArrow(i, b, c, e, Math.pow(2, c - ge[c].Sc), this) : k === $d ? Od.drawHregion(
                            i, b, c, e, this) : 19 === k && Wd.drawSingleTexture(i, b, c, e, this)
                }
        },
        ...
        Uc: function (a, b) {
            var c;
            de[a] || (c = a.toString(2), 8 > c.length && (c = Array(8 - c.length + 1).join("0") + c), de[a] =
                c);
            c = de[a];
        ...
        Wm: function (a, b, c) {
            ...
            e[e.length] = f;
            e[e.length] = c - g;
            for (var i = 2; i < a.length; i += 2) f += a[i] * b, g += a[i + 1] * b, e[e.length] = f, e[e.length] =
                c - g;
            return e
        },
        uL: function (a) {
    ...
    fa.Fp = function (a) {
        ...
        b = 0;
        for (k = this.Ve.length; b < k; b++) w = this.Ve[b], w.mr || (w.MB = q, delete w.MB, w.Un = t, this.We.push(
            w));
        o = [];
        v = f * this.Lc;
        b = 0;
        for (k = a.length; b < k; b++) {
            ...
            if (B) C = B.style, C.left = w + "px", C.top = y + "px", C.width = f + "px", C.height = f + "px", B
                ...
                if (0 < this.We.length) {
                    ...
                    C.height = f + "px";
                    E.clearRect(0, 0, v, v)
                } else B = document.createElement("canvas"), C = B.style, C.position = "absolute", this.fb.backgroundColor &&
                    (C.background = this.fb.backgroundColor), C.width = f + "px", C.height = f + "px", B.setAttribute(
                        "width", v), B.setAttribute("height", v), m.appendChild(B);
                B.id = z;
                C.left = w + "px";
                C.top = y + "px";
                o.push([n, s, B])
        ...
        if (0 === o.length) {
            ...
            for (g = 0; g < this.Ww.length; g++) i = this.Ww[g], i = a + "_" + i[0] + "_" + i[1] + "_" + e +
                "_" + c, this.nh[i] && (f[i] = this.nh[i], this.SF && this.ow.QC.PC(this.nh[i].W0, this.nh[i].l0,
                    this.nh[i].nm, this.nh[i].bn, this.nh[i].DE, this.Hd.Nd(this.nh[i].DE), this.Hd.MD(this
                        .nh[i].DE), this.fb.bE));
            this.nh = f
        } else {
            this.Bt = o.length;
    ...
    function ke(a, b, c, e, f) {
        ...
        var k = a,
            ...
            w = n[o] + "&" + s,
            w = n[o] + "¶m=" + window.encodeURIComponent(Nb(s));
        window[y] = function (a) {
            clearTimeout(i[g].dl);
            i[g] = q;
            if (a) {
    ...
    var oe = [D.url.proto + D.url.domain.TILE_BASE_URLS[0], D.url.proto + D.url.domain.TILE_BASE_URLS[1], D.url.proto +
            D.url.domain.TILE_BASE_URLS[2], D.url.proto + D.url.domain.TILE_BASE_URLS[3]],
        pe = [D.url.proto + D.url.domain.TILE_ONLINE_URLS[0] + "/tile/", D.url.proto + D.url.domain.TILE_ONLINE_URLS[
                1] + "/tile/", D.url.proto + D.url.domain.TILE_ONLINE_URLS[2] + "/tile/", D.url.proto + D.url.domain
            .TILE_ONLINE_URLS[3] + "/tile/"],
        qe = {
            dark: "dl",
            light: "ll",
            normal: "pl"
    ...
    re.getTilesUrl = function (a, b, c) {
        ...
        return "http://oto-map.everpolice-fjgj.wh.everark.com.cn/gettitle/map_baidu" + "/" + b + "/" + e + "/" + a + ".png"; // 使用本地的瓦片
    };
    var Oa = new ne("\u5730\u56fe", re, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
            maxZoom: 19
        ...
        se = new vd;
    se.tO = [D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[0] + "/resource/mappic/", D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[
            1] + "/resource/mappic/", D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[2] + "/resource/mappic/", D
        .url.proto + D.url.domain.TIlE_PERSPECT_URLS[3] + "/resource/mappic/"];
    ...
    function Y(a, b) {
        ...
        this.m.na.vg = "undefined" != typeof b && "undefined" != typeof b.renderOptions && "undefined" != typeof b.renderOptions
    ...
    A.extend(Pe.prototype, {
        ...
        TV: function () {
            ...
            if (this.page < this.bg) e = 0 == this.page % this.bg ? this.page - this.bg - 1 : this.page -
                this.page % this.bg + 1, b = e + this.bg - 1;
            else {
    ...
    A.extend(gb.prototype, {
        ...
        hn: function (a) {
            this.m.Qk = "number" == typeof a && !isNaN(a) ? 1 > a ? gb.rq : a > gb.En ? gb.rq : a : gb.rq
        },
        tf: function () {
            return this.m.Qk
        },
    ...
    function Qa(a, b) {
        function c() {
            f.m.visible ? ("inter" === f.Pe && Xa() && f.m.haveBreakId && f.m.indoorExitControl === p ? A.U.show(f.jr) :
                A.U.aa(f.jr), this.m.closeControl && this.Gf && this.P && this.P.Ta() === this.R ? A.U.show(f.Gf) :
                A.U.aa(f.Gf), this.m.forceCloseControl && A.U.show(f.Gf)) : (A.U.aa(f.Gf), A.U.aa(f.jr))
        }
    ...
    A.extend(Qa.prototype, {
        ...
        vB: function () {
            if (this.P)
                for (var a = this.P.vx(), b = 0; b < a.length; b++)(a[b] instanceof W || a[b] instanceof dd) &&
                    a[b].point && this.ta.push(a[b])
        },
        pF: ca("P"),
        du: function (a) {
            this.Sf = a || "none"
        ...
        gr: function () {
            return Xa() && !J() && "javascript" != this.m.panoramaRenderer ? "flashRender" : !J() && Rb() ?
                "cvsRender" : "cssRender"
        },
        Ra: function (a) {
            this.Oe[a.qd] = a
    ...
    function Pa(a) {
        ...
        if (A.platform.yj) {
            ...
            try {
                ...
                0 < c.indexOf("android") && (b = (c.match(/android [\d._]+/gi) + "").replace(/[^0-9|_.]/gi, "").replace(
                    /_/gi, "."), b = parseInt(b.split(".")[0], 10));
                a = b
            } catch (e) {
    ...
    A.extend(Af, {
        ...
        cS: function (a, b, c, e) {
            var c = c || "",
                f;
            !e || !a.split(e)[0] ? (e = a, a = "") : (e = a.split(e)[0], f = e.lastIndexOf("<"), e = a.substring(
                0, f), a = a.substring(f));
            f = [];
            var g = Af.Ku.width,
                i = Af.Ku.height;
    ...
    var Jf = Ef ? "-" + Ef.toLowerCase() + "-" : "",
        ...
        dg = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame ||
        window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) {
            return setTimeout(a, 1)
        },
        eg = window.cancelRequestAnimationFrame || window.H6 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame ||
    ...
    gg.prototype = {
        ...
        Rv: function (a) {
            var b;
            this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = Bf.createElement("div"), this.options
                    .eF ? b.className = this.options.eF + a.toUpperCase() : b.style.cssText =
                    "position:absolute;z-index:100;" + ("h" == a ?
                        "height:7px;bottom:1px;left:2px;right:" + (this.Gi ? "7" : "2") + "px" :
                        "width:7px;bottom:" + (this.ni ? "7" : "2") + "px;top:2px;right:1px"), b.style.cssText +=
                    ";pointer-events:none;" + Jf + "transition-property:opacity;" + Jf +
                    "transition-duration:" + (this.options.TW ? "350ms" : "0") +
                    ";overflow:hidden;opacity:" + (this.options.Gx ? "0" : "1"), this.zn.appendChild(b),
                    this[a + "ScrollbarWrapper"] = b, b = Bf.createElement("div"), this.options.eF || (
                        b.style.cssText =
                        "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" +
                        Jf + "background-clip:padding-box;" + Jf + "box-sizing:border-box;" + ("h" == a ?
                            "height:100%" : "width:100%") + ";" + Jf +
                ...
                a ? (this.TL = this.UL.clientWidth, this.lY = Cf.max(Cf.round(this.TL * this.TL / this.zy),
                    8), this.kY.style.width = this.lY + "px") : (this.RO = this.SO.clientHeight, this.S0 =
                    Cf.max(Cf.round(this.RO * this.RO / this.Vp), 8), this.R0.style.height = this.S0 +
                    "px"), this.pB(a, p)) : this[a + "ScrollbarWrapper"] && (Vf && (this[a +
                "ScrollbarIndicator"].style[Lf] = ""), this[a + "ScrollbarWrapper"].parentNode.removeChild(
                this[a + "ScrollbarWrapper"]), this[a + "ScrollbarWrapper"] = q, this[a +
        ...
        pB: function (a, b) {
            ...
            this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.oD || (c = this[
                ...
                this[a + "ScrollbarMaxScroll"] && (this.options.oD ? c = this[a + "ScrollbarMaxScroll"] :
                    (c = this[a + "ScrollbarIndicatorSize"] - Cf.round(3 * (c - this[a +
                    ...
                    "ScrollbarWrapper"].style[Qf] = "0", this[a + "ScrollbarWrapper"].style.opacity = b &&
                this.options.Gx ? "0" : "1", this[a + "ScrollbarIndicator"].style[Lf] = "translate(" +
                ("h" == a ? c + "px,0)" : "0," + c + "px)") + fg)
        },
        FQ: function (a) {
            ...
            if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() :
                a.XZ = p, a.stopPropagation(), a.preventDefault(), this.gx = this.PB = q, t
        },
        $v: function (a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && (Uf && 1 < a.touches.length) && (e = Cf.abs(a.touches[0].pageX - a.touches[
                    1].pageX), c = Cf.abs(a.touches[0].pageY - a.touches[1].pageY), this.x0 = Cf.sqrt(
                    e * e + c * c), this.hy = Cf.abs(a.touches[0].pageX + a.touches[1].pageX - 2 *
                    this.YF) / 2 - this.x, this.iy = Cf.abs(a.touches[0].pageY + a.touches[1].pageY -
                    2 * this.ZF) / 2 - this.y, this.options.Lp && this.options.Lp.call(this, a));
                if (this.options.ay && (this.options.fl ? (c = getComputedStyle(this.Rb, q)[Lf].replace(
                            /[^0-9\-.,]/g, "").split(","), e = +(c[12] || c[4]), c = +(c[13] || c[5])) : (e = +
                            getComputedStyle(this.Rb, q).left.replace(/[^0-9-]/g, ""), c = +
        ...
        ZS: function (a) {
            ...
            if (this.options.zoom && Uf && 1 < a.touches.length) f = Cf.abs(a.touches[0].pageX - a.touches[
                    1].pageX), g = Cf.abs(a.touches[0].pageY - a.touches[1].pageY), this.w0 = Cf.sqrt(f * f +
                    g * g), this.il = p, b = 1 / this.x0 * this.w0 * this.scale, b < this.options.hl ? b =
                0.5 * this.options.hl * Math.pow(2, b / this.options.hl) : b > this.options.mq && (b = 2 *
                    this.options.mq * Math.pow(0.5, this.options.mq / b)), this.Dp = b / this.scale, f =
                this.hy - this.hy * this.Dp + this.x, g = this.iy - this.iy * this.Dp + this.y, this.Rb.style[
                    Lf] = "translate(" + f + "px," + g + "px) scale(" + b + ")" + fg, this.options.nN &&
                this.options.nN.call(this, a);
            else {
                this.zh = b.pageX;
                this.Ah = b.pageY;
                if (0 < f || f < this.qe) f = this.options.No ? this.x + c / 2 : 0 <= f || 0 <= this.qe ? 0 :
                    this.qe;
                ...
                6 > this.uw && 6 > this.vw || (this.options.BE && (this.uw > this.vw + 5 ? (g = this.y, e =
                    ...
                    this.FC = 0 < c ? -1 : 0 > c ? 1 : 0, this.GC = 0 < e ? -1 : 0 > e ? 1 : 0, 300 < i -
                    this.startTime && (this.startTime = i, this.pu = this.x, this.qu = this.y), this.options
                    .kN && this.options.kN.call(this, a))
            }
        },
        iv: function (a) {
            if (!(Uf && 0 !== a.touches.length)) {
                ...
                if (b.il) e = b.scale * b.Dp, e = Math.max(b.options.hl, e), e = Math.min(b.options.mq, e),
                    b.Dp = e / b.scale, b.scale = e, b.x = b.hy - b.hy * b.Dp + b.x, b.y = b.iy - b.iy * b.Dp +
                    b.y, b.Rb.style[Nf] = "200ms", b.Rb.style[Lf] = "translate(" + b.x + "px," + b.y +
                    "px) scale(" + b.scale + ")" + fg, b.il = t, b.refresh(), b.options.Kp && b.options.Kp.call(
                        b, a);
                else {
                    if (b.yh) {
                        if (300 > k && b.options.ay) {
                            g = e ? b.jI(e - b.pu, k, -b.x, b.zy - b.Du + b.x, b.options.No ? b.Du : 0) : g;
                            i = f ? b.jI(f - b.qu, k, -b.y, 0 > b.xd ? b.Vp - b.An + b.y - b.vf : 0, b.options
                                .No ? b.An : 0) : i;
                            e = b.x + g.Ia;
                            f = b.y + i.Ia;
                        ...
                        g.Ia || i.Ia ? (c = Cf.max(Cf.max(g.time, i.time), 10), b.options.lu && (g = e - b.ww,
                            i = f - b.xw, Cf.abs(g) < b.options.Ky && Cf.abs(i) < b.options.Ky ? b.scrollTo(
                                b.ww, b.xw, 200) : (g = b.hJ(e, f), e = g.x, f = g.y, c = Cf.max(g.time,
                                c))), b.scrollTo(Cf.round(e), Cf.round(f), c)) : b.options.lu ? (g = e -
                            b.ww, i = f - b.xw, Cf.abs(g) < b.options.Ky && Cf.abs(i) < b.options.Ky ?
                            b.scrollTo(b.ww, b.xw, 200) : (g = b.hJ(b.x, b.y), (g.x != b.x || g.y != b.y) &&
                                b.scrollTo(g.x, g.y, g.time))) : b.qo(200)
                    } else {
                        if (Uf)
                            if (b.EK && b.options.zoom) clearTimeout(b.EK), b.EK = q, b.options.Lp && b.options
                                .Lp.call(b, a), b.zoom(b.zh, b.Ah, 1 == b.scale ? b.options.oW : 1), b.options
                            ...
                            "select" != f && "input" != f && "textarea" != f ? (f = Bf.createEvent(
                                "MouseEvents"), f.initMouseEvent("click", p, p, a.view, 1, c.screenX,
                                c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a
                                .metaKey, 0, q), f.xR = p, e.dispatchEvent(f)) : e.focus()
                        }
                        b.qo(400)
                    }
        ...
        qo: function (a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.yh && (this.yh = t, this.options.fy && this.options.fy.call(this)), this.ni &&
                    this.options.Gx && ("webkit" == Ef && (this.UL.style[Qf] = "300ms"), this.UL.style.opacity =
        ...
        AU: function (a) {
            ...
            if ("zoom" == b.options.ZO) {
                if (e = b.scale * Math.pow(2, 1 / 3 * (e ? e / Math.abs(e) : 0)), e < b.options.hl && (e =
                        b.options.hl), e > b.options.mq && (e = b.options.mq), e != b.scale) !b.Vy && b.options
                    .Lp && b.options.Lp.call(b, a), b.Vy++, b.zoom(a.pageX, a.pageY, e, 400), setTimeout(
                        function () {
                            b.Vy--;
        ...
        BB: function () {
            ...
            a.gm || (a.Hj.length ? (f = a.Hj.shift(), f.x == b && f.y == c && (f.time = 0), a.gm = p, a.yh =
                p, a.options.Fi) ? (a.uJ(f.time), a.Cr(f.x, f.y), a.gm = t, f.time ? a.ha(cg) : a.qo(
                0)) : (i = function () {
                var k = Date.now(),
                    m;
                if (k >= e + f.time) {
        ...
        refresh: function () {
            ...
            if ("string" == typeof this.options.lu) {
                ...
                for (b = c.length; a < b; a++) e = this.jk(c[a]), e.left += this.YF, e.top += this.ZF, this
                    .bf[a] = e.left < this.qe ? this.qe : e.left * this.scale, this.xf[a] = e.top < this.xd ?
                    this.xd : e.top * this.scale
            } else if (this.options.lu) {
                for (this.bf = []; e >= this.qe;) this.bf[b] = e, e -= this.Du, b++;
                this.qe % this.Du && (this.bf[this.bf.length] = this.qe - this.bf[this.bf.length - 1] +
                    this.bf[this.bf.length - 1]);
                b = e = 0;
                for (this.xf = []; e >= this.xd;) this.xf[b] = e, e -= this.An, b++;
                this.xd % this.An && (this.xf[this.xf.length] = this.xd - this.xf[this.xf.length - 1] +
        ...
        zoom: function (a, b, c, e) {
            var f = c / this.scale;
            this.options.fl && (this.il = p, e = e === l ? 200 : e, a = a - this.YF - this.x, b = b - this.ZF -
                this.y, this.x = a - a * f + this.x, this.y = b - b * f + this.y, this.scale = c, this.refresh(),
                this.x = 0 < this.x ? 0 : this.x < this.qe ? this.qe : this.x, this.y = this.y > this.vf ?
                this.vf : this.y < this.xd ? this.xd : this.y, this.Rb.style[Nf] = e + "ms", this.Rb.style[
                    Lf] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + fg, this.il =
                t)
        }
    };
    ...
    D.Rk(function (a) {
        ...
        a.addEventListener("position_changed", function () {
            a.m.visible && a.m.albumsControl === p && (b ? b.vy(a.Zb()) : (b = new hg(a.m.albumsControlOptions),
                b.za(a)))
        });
        a.addEventListener("albums_visible_changed", function () {
            a.m.albumsControl === p ? (b ? b.vy(a.Zb()) : (b = new hg(a.m.albumsControlOptions), b.za(
                a)), b.show()) : b.aa()
        });
    ...
    A.extend(hg.prototype, {
        Gj: function (a) {
            ...
            this.wc(this.m.anchor);
            this.R.style.width = isNaN(Number(this.m.maxWidth)) === p ? this.m.maxWidth : this.m.maxWidth +
                "px";
        ...
        vy: function (a, b) {
            if (b || !this.kk[this.cd] || !(this.kk[this.cd].panoId == a && 3 !== this.kk[this.cd].recoType)) {
                var c = this,
                    e = this.EH(a);
                    ...
                    function (a) {
                        for (var b = {}, e, k, m = t, n = [], o = 0, s = a.length; o < s; o++) e =
                            a[o].catlog, k = a[o].floor, l !== e && ("" === e && l !== k ? (m = p,
                                b[k] || (b[k] = []), b[k].push(a[o])) : (b[jg[e]] || (b[jg[e]] = []),
                                b[jg[e]].push(a[o])));
        ...
        RV: function () {
            if (this.Qi) a = this.mL(this.Ti), this.tQ.innerHTML = a;
                ...
                A.V(b, "click", function (a) {
                    if (a = (a.srcElement || a.target).getAttribute("dataindex")) {
                        ...
                        for (var e = b.getElementsByTagName("li"), f = 0, g = e.length; f < g; f++)
                            e[f].childNodes[0].getAttribute("dataindex") === a ? A.U.ib(e[f],
                                "pano_catlogLiActive") : A.U.rc(e[f], "pano_catlogLiActive")
                    }
                });
                var a = H("div"),
                    e = H("a"),
                ...
                a.appendChild(g);
                e = H("div");
                e.style.cssText = ["position:absolute;z-index:2001;left:20px;", "height:" + this.m.imageHeight +
                    "px;",
        ...
        $i: function (a) {
            this.kk = a;
            this.m.showCatalog && (0 < this.Ti.length ? (Xa() ? this.RV() : this.UV(), this.Yc.offsetLeft =
                60) : (this.Os && (this.R.removeChild(this.Os), this.Os = q, this.Yc.mg.style.left =
                    "0px"), this.Qi && (this.R.removeChild(this.Qi), this.Qi = q), this.Yc.offsetLeft =
                0));
            var b = this.zX(a);
            Xa() && (this.Ti && 0 < this.Ti.length && this.m.showExit && this.Tz) && (this.Yc.offsetLeft +=
                this.kg.width + 8, this.Os ? this.Os.innerHTML = this.Tz : this.SV());
            this.Xh.innerHTML = b;
        ...
        zX: function (a) {
            for (var b, c, e, f, g = [], i = this.kg.height, k = this.kg.width, m = 0; m < a.length; m++)
                b = a[m], recoType = b.recoType, e = b.panoId, f = b.name, c = b.heading, b = b.pitch,
                c = Af.zL(e, c, b, 198, 108), b =
    ...
    lg.prototype = {
        ...
        qs: function () {
            ...
            this.mg.children[0].style.marginTop = this.Ir.children[0].style.marginTop = this.mg.offsetHeight /
                2 - this.mg.children[0].offsetHeight / 2 + "px"
        },
        cC: function () {
            var a = this;
